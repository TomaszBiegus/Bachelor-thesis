...
{\color{orange} !!!POMOCNICZE, DO USUNIECIA!!!
Mówimy, że zbiór $E \subset X$ jest $(n, \epsilon)$-rozdzielony jeżeli dla każdych $x, y \in E,$ takich że $x \neq y$ istnieje $k \in \{0, 1, \ldots, n-1\},$ takie że $\rho(f^k(x), f^k(y)) > \epsilon.$
...
Korzystając z powyższego możemy łatwo zaadaptować twierdzenie \ref{entropia_topologiczna_odwzorowan_monotonicznych}, aby wykazać, że:
