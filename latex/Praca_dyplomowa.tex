...
Maksymalną moc $(n, \epsilon)$-rozdzielonego zbioru oznaczamy przez $s_n(f, \epsilon).$
\end{definition}
...
$$h(f) = \lim_{\epsilon \rightarrow 0} \limsup_{n \rightarrow +\infty} \frac{1}{n} \log s_n(f, \epsilon) = \lim_{\epsilon \rightarrow 0} \limsup_{n \rightarrow +\infty} \frac{1}{n} \log r_n(f, \epsilon).$$
