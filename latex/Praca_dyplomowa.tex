...
\begin{theorem}[Entropia topologiczna odwzorowań niemalejących]
\label{entropia_topologiczna_odwzorowan_niemalejących}

\textcolor{red}{TODO: wzmocnic dla monotonicznych zeby zgadzalo sie z twierdzeniem \ref{rownosc_entropii_gdy_wlokna_monotoniczne?}}


Niech $I = [0, 1]$ i niech $f: I \rightarrow I$ będzie funkcją niemalejącą.
...
Niech $X$ będzie zwartą przestrzenią metryczną, $I = [0, 1]$, $F = (f, g_x) \in C_\triangle(X \times I).$ Wtedy, jeżeli $\forall_{x \in X}$ funkcje włóknowe $g_x$ są \textcolor{red}{TODO: zmienic na tylko niemalejace zeby zgadzalo sie z twierdzeniem: \ref{entropia_topologiczna_odwzorowan_niemalejących}?} (niekoniecznie ściśle) monotoniczne to entropia topologiczna odwzorowania $F$ jest równa entropii topologicznej jego odwzorowania bazowego $f$, czyli:
...
Z twierdzenia \ref{entropia_topologiczna_odwzorowan_niemalejących} i faktu, że wszystkie odwzorowania włóknowe $g_x$ są niemalejące mamy :
