...
Niech $(X, \rho)$ będzie zwartą przestrzenią metryczną bez punktów izolowanych, $f \in C(X)$ odwzorowaniem chaotycznym w sensie Devaneya, $P$ skończonym zbiorem niezmienniczym ze względu na $f$, a $V$ otwartym otoczeniem zbioru $P$ \textcolor{red}{TODO: dodefiniować co znaczy otoczenie zbioru?}.
