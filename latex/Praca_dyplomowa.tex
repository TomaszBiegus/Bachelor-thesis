...
Następnie korzystając z przypadku 1 dostajemy odwzorowanie $G \in \mathcal{F}_{SO}^i$, dla którego zachodzi nierówność $d_2(G, H) < \frac{\epsilon}{2}$. Wówczas $d_2(G, F) < \epsilon$. (TODO powolac sie na nierownosc trojkata)
